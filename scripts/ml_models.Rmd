...
We want to now look at the metrics for all the models used. For now we just visualize the predictions against the actual outcomes, and we will fill more here in due time.
